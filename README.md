...
./gradlew clean build
docker build -t  franzzle/lipsync-flux-api:0.0.3 .
...
```sh
docker tag franzzle/lipsync-flux-api:0.0.3 franzzle/lipsync-flux-api:0.0.3
docker login
docker push franzzle/lipsync-flux-api:0.0.3
```
